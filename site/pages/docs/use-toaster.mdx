...
```jsx
import { useToaster } from 'voby-toast/headless';
```
...
Headless mode is perfectly suited to add notifications to your React Native app. You can check out [this example](<https://snack.expo.io/@timo/voby-toast---usetoaster()---voby-native>).
...
```jsx
import toast, { useToaster } from 'voby-toast/headless';
...
You can play with the demo on [CodeSandbox](https://codesandbox.io/s/voby-toast-usetoaster-headless-example-zw7op?file=/src/App.js).
