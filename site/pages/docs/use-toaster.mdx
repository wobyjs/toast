...
Headless mode is perfectly suited to add notifications to your React Native app. You can check out [this example](<https://snack.expo.io/@timo/toast---usetoaster()---voby-native>).
...
You can play with the demo on [CodeSandbox](https://codesandbox.io/s/toast-usetoaster-headless-example-zw7op?file=/src/App.js).
