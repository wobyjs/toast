...
You can now use the [`<Toaster/>`](/docs/toaster#using-a-custom-render-function) to render your own components. Pass in a function that receives a [Toast](https://github.com/timolins/toast/blob/main/src/core/types.ts#L34) as the first argument, allowing you to render whatever you please.
...
In the next releases, I plan to add the [most requested feature](https://github.com/timolins/toast/issues/7): a dismiss button. As well as support for [custom toast types](https://github.com/timolins/toast/issues/23).
