...
You can provide your **own render function** to the Toaster by passing it as children. It will be called for each [Toast](https://github.com/timolins/voby-toast/blob/main/src/core/types.ts#L34) allowing you to render any component based on the toast state.

### Minimal example

```jsx
import { Toaster, resolveValue } from 'voby-toast';
...
```jsx
import { Toaster, ToastBar } from 'voby-toast';
